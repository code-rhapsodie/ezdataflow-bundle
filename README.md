...
Before use the admin UI for manage your dataflows, you need define it. Please refer you to the [Code-Rhapsodie Dataflow type documentation](https://github.com/code-rhapsodie/dataflow-bundle#define-a-dataflow-type).
